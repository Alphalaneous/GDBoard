...
public class BlockedGDUserSettings {
		...
		button.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				new Thread(() -> {
					...
					String option = DialogBox.showDialogBox("Unblock " + button.getLText() + "?", "<html>This will unblock the GD user and allow their levels again.<html>", "", new String[]{"Yes", "No"});
