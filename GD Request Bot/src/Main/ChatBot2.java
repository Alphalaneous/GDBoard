...
public class ChatBot2 extends TwitchBot {
    ...
    public boolean checkMod(String user){
        return Main.mods.contains(user);
    }
    /*public void doCommand(String user, String command, String[] args){
        ...
        try {
            ...
            if (command.equalsIgnoreCase("!p") ||
                ...
                try {
                    sendMessage("@" + user + ", " + userLevels.get(intArg - 1).getName()
                            + " is at position " + userPosition.get(intArg - 1) + " in the queue!", channel);
                } catch (IndexOutOfBoundsException e) {
