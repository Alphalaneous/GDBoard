...
public class GeometryDashCommands {
	...
	public static JPanel createPanel() {
		...
		titlePanel.add(new SettingsTitle("$GEOMETRY_DASH_COMMANDS_SETTINGS$"));
	...
	public static void loadCommands(){
		for(CommandData commandData : LoadCommands.geometryDashCommands){
	...
	public static void resizeHeight(int height){
		...
		scrollPane.setBounds(0, 80, 524, height-120);
	}
}
