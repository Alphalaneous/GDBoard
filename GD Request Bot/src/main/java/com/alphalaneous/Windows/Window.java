...
public class Window {
    ...
    private static final JLayeredPane layeredContentPanel = new JLayeredPane() {
    ...
    public static void initFrame() {
        ...
        //windowFrame.setMinimumSize(new Dimension(width, height + 30));
    ...
    public static void showDialog(JComponent component) {
        ...
        component.setBounds(windowFrame.getWidth() / 2 - component.getWidth() / 2, windowFrame.getHeight() / 2 - component.getHeight() / 2 - 31, component.getWidth(), component.getHeight());
    ...
    private static void startComponentListener() {
        windowFrame.addComponentListener(new ComponentAdapter() {
            public void componentResized(ComponentEvent evt) {
                ...
                fullPanel.setBounds(0, 0, windowFrame.getWidth(), windowFrame.getHeight());
                if (dialogComponent != null) {
                    dialogComponent.setBounds(windowFrame.getWidth() / 2 - dialogComponent.getWidth() / 2, windowFrame.getHeight() / 2 - dialogComponent.getHeight() / 2 - 31, dialogComponent.getWidth(), dialogComponent.getHeight());
                }
    ...
    private static class ListButton extends JButton {
